...
#define CMAC_A_S_STATUS_BWID ICFG_CSB_DATA_BWID

// Pointer for CSB master and data path to access groups
#define CMAC_A_S_POINTER "cmac_a_s_pointer"
#define CMAC_A_S_POINTER_ADDR 0x7004
#define CMAC_A_S_POINTER_BWID ICFG_CSB_DATA_BWID
...
#define CMAC_A_D_OP_ENABLE_BWID ICFG_CSB_DATA_BWID
...
#define CMAC_A_D_MISC_CFG_BWID ICFG_CSB_DATA_BWID
