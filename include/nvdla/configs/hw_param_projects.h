...
// File Name: hw_param_projects.h

#ifndef HW_PARAM_PROJECTS_H__
#define HW_PARAM_PROJECTS_H__

#if defined(FEATURE_DATA_TYPE_INT8)
#define NVDLA_FEATURE_DATA_TYPE_INT8 #define NVDLA_BPE 8
#elif defined(FEATURE_DATA_TYPE_INT16_FP16)
#define NVDLA_FEATURE_DATA_TYPE_INT16_FP16 #define NVDLA_BPE 16
#else
...
#define NVDLA_SDP_MAX_THROUGHPUT                                               \
  max(NVDLA_SDP_EW_THROUGHPUT, NVDLA_SDP_BN_THROUGHPUT, NVDLA_SDP_BS_THROUGHPUT)
...
#if defined(SECONDARY_MEMIF_ENABLE)
#define NVDLA_MEMIF_WIDTH
max(NVDLA_PRIMARY_MEMIF_WIDTH, NVDLA_SECONDARY_MEMIF_WIDTH,
    NVDLA_MEMORY_ATOMIC_SIZE* NVDLA_BPE)
#elif defined(SECONDARY_MEMIF_DISABLE)
#define NVDLA_MEMIF_WIDTH                                                      \
...
#define NVDLA_DMA_MASK_BIT                                                     \
  int(NVDLA_MEMIF_WIDTH / NVDLA_BPE / NVDLA_MEMORY_ATOMIC_SIZE)
...
#define NVDLA_CBUF_DEPTH_LOG2                                                  \
  log2(NVDLA_CBUF_BANK_NUMBER) + log2(NVDLA_CBUF_BANK_DEPTH)
...
#define NVDLA_CC_ATOMC_DIV_ATOMK                                               \
  int(NVDLA_MAC_ATOMIC_C_SIZE / NVDLA_MAC_ATOMIC_K_SIZE)

#endif // HW_PARAM_PROJECTS_H__
